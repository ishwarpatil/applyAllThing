        ...
        return (
            <Switch>
                ...
                <div className="App">
                    ...
                    <PrivateRoute exact path="/reactTable" component={ReactTable}/>
                    <PrivateRoute exact path="/dragDrop" component={DragDrop}/>
                    <PrivateRoute exact path="/reactBootstrapTable" component={ReactBootstrapTable}/>
